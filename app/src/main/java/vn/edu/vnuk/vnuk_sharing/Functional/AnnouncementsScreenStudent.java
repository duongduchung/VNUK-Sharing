...
public class AnnouncementsScreenStudent extends AppCompatActivity {
    ...
    {
        lv.setOnItemClickListener(new AnnouncementsScreenStudent.MyListViewEvent());
    }
    ...
    private class MyListViewEvent implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Toast.makeText(AnnouncementsScreenStudent.this,
