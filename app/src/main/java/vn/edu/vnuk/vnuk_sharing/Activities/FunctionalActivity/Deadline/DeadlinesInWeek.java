package vn.edu.vnuk.vnuk_sharing.Activities.FunctionalActivity.Deadline;
...
public class DeadlinesInWeek {
    ...
    public DeadlinesInWeek(String title, String desciption, Date dateFinish,
                           Date hourFinish) {
        super();
        this.title = title;
        this.desciption = desciption;
